...
**Related:** root-cause investigation — `docs/mqtt-broker-credentials-investigation.md` in the [`sensors2mqtt`](https://github.com/mithro/sensors2mqtt) repo
...
Full evidence: `docs/mqtt-broker-credentials-investigation.md` in the
[`sensors2mqtt`](https://github.com/mithro/sensors2mqtt) repo.
